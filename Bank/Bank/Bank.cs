...
{
    class Bank<TClientKey, TAccountKey , TTransactionKey> : IBank<TClientKey, TAccountKey , TTransactionKey>
        ...
        where TTransactionKey : IEquatable<TTransactionKey>, IComparable<TTransactionKey>
    {
        ...
        private Queue<Transaction.Transaction<TTransactionKey, TAccountKey>> TransactionQueue = new Queue<Transaction.Transaction<TTransactionKey, TAccountKey>>();
        ...
        public void AddTranstion(Transaction.Transaction<TTransactionKey,TAccountKey> transaction)
        {
